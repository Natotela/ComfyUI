...
for %f in (F:\Progz\stable-diffusion-webui\models\RealESRGAN\*) do mklink F:\Progz\Comfy\models\upscale_models\%~nxf %f
for %f in (F:\Progz\stable-diffusion-webui\models\SwinIR\*) do mklink F:\Progz\Comfy\models\upscale_models\%~nxf %f